...
export class FourGangSwitchDevice extends BaseDevice {
    private switch1!: Switch;
    private switch2!: Switch;
    private switch3!: Switch;
    private switch4!: Switch;
    ...
    initialize(): void {
        ...
        this.switch4 = new Switch(
            this.platform,
            this.accessory,
            this.mqttClient,
            `${this.accessory.context.device.displayName} Switch 4`,
            'switch4',
            3 // Bit index for the fourth switch
        );
        ...
        this.masterSwitch = new Switch(
            ...
            4 // Number of switches this master switch controls
        );
    }
    ...
    updateCharacteristics(deviceState: any): void {
        ...
        if (deviceState.s && Array.isArray(deviceState.s) && deviceState.s.length > 1) {
            ...
            const switch4State = binaryState[3] === '1';
            ...
            this.switch4.updateCharacteristic(switch4State);

            // Update master switch
            const masterState = switch1State && switch2State && switch3State && switch4State;
